...
export class MetricsManager {
    ...
    private static createProviderMetrics(): Record<ProviderType, ProviderMetrics> {
        return {
            [ProviderType.GEMINI]: {
                usage: 0,
                successes: 0,
    ...
    private static providerMetrics = this.createProviderMetrics();
    ...
    static recordSuccess(
        ...
        metrics.averageLatency = Number(
            (metrics.totalLatency / metrics.usage).toFixed(2)
        );
    }
    ...
    static getProviderMetrics(
        ...
        return structuredClone(this.providerMetrics[provider]);
    }
        ...
        return {
            ...
            averageLatency:
                completed === 0
                    ? 0
                    : Number(
                        (this.totalLatency / completed).toFixed(2)
                    ),
    ...
    static reset(): void {
        ...
        helixLogger.info("Metrics reset");
