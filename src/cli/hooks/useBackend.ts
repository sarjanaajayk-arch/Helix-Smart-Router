...
import { AIModelInfo } from '../../providers/AIProvider';
...
export const useBackend = (setState: React.Dispatch<React.SetStateAction<any>>) => {
      ...
      for (const [providerName, providerModels] of Object.entries(allModels)) {
        for (const model of providerModels) {
          ...
          models.push({
                      ...
                      priority: 1,
                      // AIModelInfo doesn't have enabled - use providerHealthy instead
